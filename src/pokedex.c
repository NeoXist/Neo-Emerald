...
static const struct SearchOptionText sDexModeOptions[] =
{
    ...
    [DEX_MODE_NEO_HOENN] = {gText_DexNeoHoennDescription, gText_DexNeoHoennTitle},
...
void ResetPokedex(void)
{
    ...
    gUnusedPokedexU8 = 0;
    gSaveBlock2Ptr->pokedex.mode = DEX_MODE_NEO_HOENN;
...
static void ResetPokedexView(struct PokedexView *pokedexView)
{
    ...
    pokedexView->dexMode = DEX_MODE_NEO_HOENN;
    pokedexView->dexModeBackup = DEX_MODE_NEO_HOENN;
...
void CB2_OpenPokedex(void)
{
    ...
    case 2:
        ...
        if (!IsNationalPokedexEnabled())
            sPokedexView->dexMode = DEX_MODE_NEO_HOENN;
...
#define temp_dexNum     vars[2]
    ...
    case DEX_MODE_HOENN:
        ...
        break;
    case DEX_MODE_NEO_HOENN:
        temp_dexCount = NEO_HOENN_DEX_COUNT;
        temp_isHoennDex = TRUE;
        break;
...
static void CreateMonDexNum(u16 entryNum, u8 left, u8 top, u16 unused)
{
    ...
    else if (sPokedexView->dexMode == DEX_MODE_NEO_HOENN)
        dexNum = NationalToNeoHoennOrder(dexNum);
    memcpy(text, sText_No0000, ARRAY_COUNT(sText_No0000));
    if (NATIONAL_DEX_COUNT > 999 && sPokedexView->dexMode != DEX_MODE_HOENN && sPokedexView->dexMode != DEX_MODE_NEO_HOENN)
    {
...
static void Task_LoadInfoScreen(u8 taskId)
{
    ...
    case 3:
        ...
        break;
    case 4:
        PrintMonInfo(sPokedexListItem->dexNum, (sPokedexView->dexMode == DEX_MODE_HOENN || sPokedexView->dexMode == DEX_MODE_NEO_HOENN) ? FALSE : TRUE, sPokedexListItem->owned, 0);
