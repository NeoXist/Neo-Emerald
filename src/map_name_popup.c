...
static const u8 sMapSectionToThemeId[MAPSEC_COUNT - KANTO_MAPSEC_COUNT - 1] =
{
    ...
    [MAPSEC_DEWFORD_ISLE] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_PACIFIDLOG_ISLE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_PETALBURG_TOWN] = MAPPOPUP_THEME_BRICK,
    ...
    [MAPSEC_FORTREE_VILLAGE] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_LILYCOVE_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_MOSSDEEP_ISLE] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_SOOTOPOLIS_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_EVER_GRANDE_SUMMIT] = MAPPOPUP_THEME_BRICK,
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_DEWFORD_ISLE] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_PACIFIDLOG_ISLE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_PETALBURG_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_FORTREE_VILLAGE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_LILYCOVE_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_MOSSDEEP_ISLE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_SOOTOPOLIS_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_EVER_GRANDE_SUMMIT] = MAPPOPUP_THEME_BW_DEFAULT,
