...
static bool32 IsValidLocationForVsSeeker(void)
{
    ...
    Location validIndoorLocations[] =
    {
        ...
        { MAP_GROUP(MAP_DEWFORD_ISLE_GYM),         MAP_NUM(MAP_DEWFORD_ISLE_GYM) },
        ...
        { MAP_GROUP(MAP_PETALBURG_TOWN_GYM),       MAP_NUM(MAP_PETALBURG_TOWN_GYM) },
        { MAP_GROUP(MAP_FORTREE_VILLAGE_GYM),         MAP_NUM(MAP_FORTREE_VILLAGE_GYM) },
        { MAP_GROUP(MAP_MOSSDEEP_ISLE_GYM),        MAP_NUM(MAP_MOSSDEEP_ISLE_GYM) },
