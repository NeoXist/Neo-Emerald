...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_DECIDUEYE_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_OVERGROW, ABILITY_NONE, ABILITY_QUICK_DRAW },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Decidueye"),
        .cryId = CRY_DECIDUEYE,
        .natDexNum = NATIONAL_DEX_DECIDUEYE,
    ...
    [SPECIES_CUTIEFLY] =
    {
        ...
        .abilities = { ABILITY_SWEET_VEIL, ABILITY_SHIELD_DUST, ABILITY_MISTY_SURGE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_ROCKRUFF] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_NONE, ABILITY_SAND_RUSH },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LYCANROC_MIDDAY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_NONE, ABILITY_SAND_FORCE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LYCANROC_MIDNIGHT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TOUGH_CLAWS, ABILITY_NONE, ABILITY_NO_GUARD },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Lycanroc"),
    ...
    [SPECIES_MAREANIE] =
    {
        ...
        .abilities = { ABILITY_REGENERATOR, ABILITY_CORROSION, ABILITY_MERCILESS },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_MUDBRAY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SHEER_FORCE, ABILITY_STAMINA, ABILITY_INNER_FOCUS },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_SALAZZLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_CORROSION, ABILITY_ABILITY_MERCILESS, ABILITY_PROWESS },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_STEENEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_LEAF_GUARD, ABILITY_OBLIVIOUS, ABILITY_STRIKER },
        .bodyColor = BODY_COLOR_PURPLE,
        .noFlip = TRUE,
    ...
    [SPECIES_TSAREENA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_MAJESTIC, ABILITY_QUEENLY_MAJESTY, ABILITY_STRIKER },
        .bodyColor = BODY_COLOR_PURPLE,
        .noFlip = TRUE,
    ...
    [SPECIES_WIMPOD] =
    {
        ...
        .abilities = { ABILITY_WIMP_OUT, ABILITY_NONE, ABILITY_SHELL_ARMOR },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_SANDYGAST] =
    {
        ...
        .abilities = { ABILITY_WATER_COMPACTION, ABILITY_NONE, ABILITY_SAND_SPIT },
        .bodyColor = BODY_COLOR_BROWN,
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal, type1, type2)          \
    {                                                           \
        .baseHP        = 60,                                    \
        .baseAttack    = 120,                                   \
        .baseDefense   = 60,                                    \
    ...
    [SPECIES_MINIOR_CORE_RED]      = MINIOR_CORE_SPECIES_INFO(Red,    BODY_COLOR_RED,    0, TYPE_ROCK, TYPE_PSYCHIC),
    [SPECIES_MINIOR_CORE_ORANGE]   = MINIOR_CORE_SPECIES_INFO(Orange, BODY_COLOR_RED,    0, TYPE_ROCK, TYPE_FIRE),
    [SPECIES_MINIOR_CORE_YELLOW]   = MINIOR_CORE_SPECIES_INFO(Yellow, BODY_COLOR_YELLOW, 0, TYPE_ROCK, TYPE_ELECTRIC),
    [SPECIES_MINIOR_CORE_GREEN]    = MINIOR_CORE_SPECIES_INFO(Green,  BODY_COLOR_GREEN,  1, TYPE_ROCK, TYPE_GRASS),
    [SPECIES_MINIOR_CORE_BLUE]     = MINIOR_CORE_SPECIES_INFO(Blue,   BODY_COLOR_BLUE,   0, TYPE_ROCK, TYPE_WATER),
    [SPECIES_MINIOR_CORE_INDIGO]   = MINIOR_CORE_SPECIES_INFO(Indigo, BODY_COLOR_BLUE,   0, TYPE_ROCK, TYPE_ICE),
    [SPECIES_MINIOR_CORE_VIOLET]   = MINIOR_CORE_SPECIES_INFO(Violet, BODY_COLOR_PURPLE, 2, TYPE_ROCK, TYPE_DRAGON),
    ...
    [SPECIES_DHELMISE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_STEELWORKER, ABILITY_NONE, ABILITY_NATURAL_CURE },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_HAKAMO_O] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_BULLETPROOF, ABILITY_SOUNDPROOF, ABILITY_BATTLE_ARMOR },
        .bodyColor = BODY_COLOR_GRAY,
