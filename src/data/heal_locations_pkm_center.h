...
static const struct HealLocation sHealLocationsPokemonCenter[NUM_HEAL_LOCATIONS - 1] =
{
    ...
    {
        .mapGroup = MAP_GROUP(MAP_PETALBURG_TOWN_POKEMON_CENTER_1F),
        .mapNum = MAP_NUM(MAP_PETALBURG_TOWN_POKEMON_CENTER_1F),
    ...
    {
        .mapGroup = MAP_GROUP(MAP_FORTREE_VILLAGE_POKEMON_CENTER_1F),
        .mapNum = MAP_NUM(MAP_FORTREE_VILLAGE_POKEMON_CENTER_1F),
        DEFAULT_POKEMON_CENTER_COORDS,
    },
    ...
    {
        .mapGroup = MAP_GROUP(MAP_MOSSDEEP_ISLE_POKEMON_CENTER_1F),
        .mapNum = MAP_NUM(MAP_MOSSDEEP_ISLE_POKEMON_CENTER_1F),
        DEFAULT_POKEMON_CENTER_COORDS,
    },
    ...
    {
        .mapGroup = MAP_GROUP(MAP_EVER_GRANDE_SUMMIT_POKEMON_CENTER_1F),
        .mapNum = MAP_NUM(MAP_EVER_GRANDE_SUMMIT_POKEMON_CENTER_1F),
        DEFAULT_POKEMON_CENTER_COORDS,
    },
    ...
    {
        .mapGroup = MAP_GROUP(MAP_DEWFORD_ISLE_POKEMON_CENTER_1F),
        .mapNum = MAP_NUM(MAP_DEWFORD_ISLE_POKEMON_CENTER_1F),
        DEFAULT_POKEMON_CENTER_COORDS,
    },
    ...
    {
        .mapGroup = MAP_GROUP(MAP_PACIFIDLOG_ISLE_POKEMON_CENTER_1F),
        .mapNum = MAP_NUM(MAP_PACIFIDLOG_ISLE_POKEMON_CENTER_1F),
        DEFAULT_POKEMON_CENTER_COORDS,
    },
    [HEAL_LOCATION_EVER_GRANDE_SUMMIT_POKEMON_LEAGUE - 1] =
    {
        .mapGroup = MAP_GROUP(MAP_EVER_GRANDE_SUMMIT_POKEMON_LEAGUE_1F),
        .mapNum = MAP_NUM(MAP_EVER_GRANDE_SUMMIT_POKEMON_LEAGUE_1F),
        .x = 3,
        .y = 4,
    },
...
static const u8 sHealNpcLocalId[NUM_HEAL_LOCATIONS - 1] =
{
    ...
    [HEAL_LOCATION_DEWFORD_ISLE - 1] = 1,
    [HEAL_LOCATION_LAVARIDGE_TOWN - 1] = 1,
    [HEAL_LOCATION_FALLARBOR_TOWN - 1] = 1,
    [HEAL_LOCATION_VERDANTURF_TOWN - 1] = 1,
    [HEAL_LOCATION_PACIFIDLOG_ISLE - 1] = 1,
    [HEAL_LOCATION_EVER_GRANDE_SUMMIT_POKEMON_LEAGUE - 1] = 1,
