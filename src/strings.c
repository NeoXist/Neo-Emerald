...
const u8 gText_DexNeoHoennTitle[] = _("NEO-HOENN DEX");
...
const u8 gText_DexNeoHoennDescription[] = _("NEO-HOENN region's POKéDEX");
...
const u8 gText_DexNeoHoenn[] = _("NEO-HOENN");
