...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_DEWFORD_ISLE] = {MAP_GROUP(MAP_DEWFORD_ISLE), MAP_NUM(MAP_DEWFORD_ISLE), HEAL_LOCATION_DEWFORD_ISLE},
    ...
    [MAPSEC_PACIFIDLOG_ISLE] = {MAP_GROUP(MAP_PACIFIDLOG_ISLE), MAP_NUM(MAP_PACIFIDLOG_ISLE), HEAL_LOCATION_PACIFIDLOG_ISLE},
    [MAPSEC_PETALBURG_TOWN] = {MAP_GROUP(MAP_PETALBURG_TOWN), MAP_NUM(MAP_PETALBURG_TOWN), HEAL_LOCATION_PETALBURG_TOWN},
    ...
    [MAPSEC_FORTREE_VILLAGE] = {MAP_GROUP(MAP_FORTREE_VILLAGE), MAP_NUM(MAP_FORTREE_VILLAGE), HEAL_LOCATION_FORTREE_VILLAGE},
    [MAPSEC_LILYCOVE_CITY] = {MAP_GROUP(MAP_LILYCOVE_CITY), MAP_NUM(MAP_LILYCOVE_CITY), HEAL_LOCATION_LILYCOVE_CITY},
    [MAPSEC_MOSSDEEP_ISLE] = {MAP_GROUP(MAP_MOSSDEEP_ISLE), MAP_NUM(MAP_MOSSDEEP_ISLE), HEAL_LOCATION_MOSSDEEP_ISLE},
    [MAPSEC_SOOTOPOLIS_CITY] = {MAP_GROUP(MAP_SOOTOPOLIS_CITY), MAP_NUM(MAP_SOOTOPOLIS_CITY), HEAL_LOCATION_SOOTOPOLIS_CITY},
    [MAPSEC_EVER_GRANDE_SUMMIT] = {MAP_GROUP(MAP_EVER_GRANDE_SUMMIT), MAP_NUM(MAP_EVER_GRANDE_SUMMIT), HEAL_LOCATION_EVER_GRANDE_SUMMIT},
...
static const u8 *const sEverGrandeSummitNames[] =
{
    gText_PokemonLeague,
    gText_PokemonCenter
};
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_DEWFORD_ISLE:
        return FlagGet(FLAG_VISITED_DEWFORD_ISLE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    ...
    case MAPSEC_PACIFIDLOG_ISLE:
        return FlagGet(FLAG_VISITED_PACIFIDLOG_ISLE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_PETALBURG_TOWN:
        return FlagGet(FLAG_VISITED_PETALBURG_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    ...
    case MAPSEC_FORTREE_VILLAGE:
        return FlagGet(FLAG_VISITED_FORTREE_VILLAGE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_LILYCOVE_CITY:
        return FlagGet(FLAG_VISITED_LILYCOVE_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_MOSSDEEP_ISLE:
        return FlagGet(FLAG_VISITED_MOSSDEEP_ISLE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_SOOTOPOLIS_CITY:
        return FlagGet(FLAG_VISITED_SOOTOPOLIS_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_EVER_GRANDE_SUMMIT:
        return FlagGet(FLAG_VISITED_EVER_GRANDE_SUMMIT) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    for (mapSecId = MAPSEC_LITTLEROOT_TOWN; mapSecId <= MAPSEC_EVER_GRANDE_SUMMIT; mapSecId++)
    {
...
u32 FilterFlyDestination(struct RegionMap* regionMap)
{
    ...
    case MAPSEC_EVER_GRANDE_SUMMIT:
        return (FlagGet(FLAG_LANDMARK_POKEMON_LEAGUE) && regionMap->posWithinMapSec == 0 ? HEAL_LOCATION_EVER_GRANDE_SUMMIT_POKEMON_LEAGUE : HEAL_LOCATION_EVER_GRANDE_SUMMIT);
    default:
