...
} static const sRestrictedReleaseMoves[] =
{
    ...
    {MAP_GROUP(MAP_EVER_GRANDE_SUMMIT_POKEMON_LEAGUE_1F), MAP_NUM(MAP_EVER_GRANDE_SUMMIT_POKEMON_LEAGUE_1F), MOVE_STRENGTH},
    {MAP_GROUP(MAP_EVER_GRANDE_SUMMIT_POKEMON_LEAGUE_1F), MAP_NUM(MAP_EVER_GRANDE_SUMMIT_POKEMON_LEAGUE_1F), MOVE_ROCK_SMASH},
    {MAP_GROUP(MAP_EVER_GRANDE_SUMMIT_POKEMON_LEAGUE_2F), MAP_NUM(MAP_EVER_GRANDE_SUMMIT_POKEMON_LEAGUE_2F), MOVE_STRENGTH},
    {MAP_GROUP(MAP_EVER_GRANDE_SUMMIT_POKEMON_LEAGUE_2F), MAP_NUM(MAP_EVER_GRANDE_SUMMIT_POKEMON_LEAGUE_2F), MOVE_ROCK_SMASH},
};
