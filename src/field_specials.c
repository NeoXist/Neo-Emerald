...
bool8 UsedPokemonCenterWarp(void)
{
    static const u16 sPokemonCenters[] =
    {
        ...
        MAP_DEWFORD_ISLE_POKEMON_CENTER_1F,
        MAP_LAVARIDGE_TOWN_POKEMON_CENTER_1F,
        MAP_FALLARBOR_TOWN_POKEMON_CENTER_1F,
        MAP_VERDANTURF_TOWN_POKEMON_CENTER_1F,
        MAP_PACIFIDLOG_ISLE_POKEMON_CENTER_1F,
        MAP_PETALBURG_TOWN_POKEMON_CENTER_1F,
        MAP_SLATEPORT_CITY_POKEMON_CENTER_1F,
        MAP_MAUVILLE_CITY_POKEMON_CENTER_1F,
        MAP_RUSTBORO_CITY_POKEMON_CENTER_1F,
        MAP_FORTREE_VILLAGE_POKEMON_CENTER_1F,
        MAP_LILYCOVE_CITY_POKEMON_CENTER_1F,
        MAP_MOSSDEEP_ISLE_POKEMON_CENTER_1F,
        MAP_SOOTOPOLIS_CITY_POKEMON_CENTER_1F,
        MAP_EVER_GRANDE_SUMMIT_POKEMON_CENTER_1F,
        MAP_EVER_GRANDE_SUMMIT_POKEMON_LEAGUE_1F,
...
u32 GetMartEmployeeObjectEventId(void)
{
    static const u8 sPokeMarts[][3] =
    {
        ...
        { MAP_GROUP(MAP_PETALBURG_TOWN_MART),  MAP_NUM(MAP_PETALBURG_TOWN_MART),  LOCALID_PETALBURG_MART_CLERK },
        ...
        { MAP_GROUP(MAP_FORTREE_VILLAGE_MART), MAP_NUM(MAP_FORTREE_VILLAGE_MART), LOCALID_FORTREE_MART_CLERK },
        { MAP_GROUP(MAP_MOSSDEEP_ISLE_MART),   MAP_NUM(MAP_MOSSDEEP_ISLE_MART),   LOCALID_MOSSDEEP_MART_CLERK },
...
{
    if (gSaveBlock1Ptr->lastHealLocation.mapGroup == MAP_GROUP(MAP_DEWFORD_ISLE) && gSaveBlock1Ptr->lastHealLocation.mapNum == MAP_NUM(MAP_DEWFORD_ISLE))
        SetLastHealLocationWarp(HEAL_LOCATION_PETALBURG_TOWN);
}
