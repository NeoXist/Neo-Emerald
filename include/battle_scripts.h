...
extern const u8 BattleScript_MajesticActivates[];
extern const u8 BattleScript_ScarecrowActivates[];
...
extern const u8 BattleScript_SelectingNotAllowedMoveRagingFrenzy[];
extern const u8 BattleScript_SelectingNotAllowedMoveRagingFrenzyInPalace[];
