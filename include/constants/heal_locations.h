...
enum {
    ...
    HEAL_LOCATION_PETALBURG_TOWN,
    HEAL_LOCATION_SLATEPORT_CITY,
    HEAL_LOCATION_MAUVILLE_CITY,
    HEAL_LOCATION_RUSTBORO_CITY,
    HEAL_LOCATION_FORTREE_VILLAGE,
    HEAL_LOCATION_LILYCOVE_CITY,
    HEAL_LOCATION_MOSSDEEP_ISLE,
    HEAL_LOCATION_SOOTOPOLIS_CITY,
    HEAL_LOCATION_EVER_GRANDE_SUMMIT,
    HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE,
    HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE,
    HEAL_LOCATION_OLDALE_TOWN,
    HEAL_LOCATION_DEWFORD_ISLE,
    HEAL_LOCATION_LAVARIDGE_TOWN,
    HEAL_LOCATION_FALLARBOR_TOWN,
    HEAL_LOCATION_VERDANTURF_TOWN,
    HEAL_LOCATION_PACIFIDLOG_ISLE,
    HEAL_LOCATION_EVER_GRANDE_SUMMIT_POKEMON_LEAGUE,
    HEAL_LOCATION_SOUTHERN_ISLAND_EXTERIOR,
    HEAL_LOCATION_BATTLE_FRONTIER_OUTSIDE_EAST,
    NUM_HEAL_LOCATIONS
};

// Legacy heal-location compatibility aliases.
#define HEAL_LOCATION_PETALBURG_CITY HEAL_LOCATION_PETALBURG_TOWN
#define HEAL_LOCATION_FORTREE_CITY HEAL_LOCATION_FORTREE_VILLAGE
#define HEAL_LOCATION_EVER_GRANDE_CITY HEAL_LOCATION_EVER_GRANDE_SUMMIT
#define HEAL_LOCATION_EVER_GRANDE_CITY_POKEMON_LEAGUE HEAL_LOCATION_EVER_GRANDE_SUMMIT_POKEMON_LEAGUE
